...
from SDN.PointerLSTM2Heads import PointerNetwork
...
def main():
    ...
    for epoch in range(args.start_epoch, args.nof_epoch):
            ...
            for i_batch, sample_batch in enumerate(train_dataloader):
                ...
                iou_rate = Losses.Metrics.get_avg_iou(np.reshape(pred_positions.data.cpu().numpy(), (-1, 2)),
                ...
                ordered_iou_rate = Losses.Metrics.get_avg_iou(np.reshape(pred_positions[:, :args.n_outputs, :].data.cpu().numpy(), (-1, 2)),
