...
from ActionLocalizationDevs.datasets.THUMOS14.dataloader_c3dd_4 import THUMOST14
...
parser.add_argument('--resume', '-r', default='/home/zwei/Dev/NetModules/PtrNet2/lstm2heads_proposal_c3d_s4_ckpt', type=str, help='resume from previous ')
parser.add_argument('--fileid', type=int, default=25, help='file id in ckpt file')
