...
from Exp_Synthetic2.Minist_Apperance.CreateMNIST_2Heads_online_v1 import MNIST
...
def main():
    ...
    save_directory = 'gru2heads_mnist_s4-3_ckpt'
    ...
    train_dataset = MNIST(seq_length=args.seq_len, overlap=0.9, sample_rate=1)
