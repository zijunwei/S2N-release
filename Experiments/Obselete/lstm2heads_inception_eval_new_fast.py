...
parser.add_argument('--eval', type=str, default='/home/zwei/Dev/NetModules/PtrNet2/gru2heads_proposal_s4-3_EMD_ckpt', help='check-point file')
parser.add_argument('--fileid', type=int, default=3, help='file id in ckpt file')
...
def main():
    ...
    proposal_save_file = 'Dev/NetModules/ActionLocalizationDevs/PropEval/baselines_results/inception-s4-EMD-gru-{:04d}_thumos14_test.csv'.format(ckpt_idx)
