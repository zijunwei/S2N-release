...
from Devs_SyntheticV2.SDN_MNIST_s1_1_online import cDataset #Update: output top 3!
...
import PyUtils.log_utils as chinese_utils
...
def main():
    ...
    save_directory = dir_utils.get_dir(os.path.join(project_root, 'ckpts', 'Delete-{:s}-assgin{:.2f}-alpha{:.4f}-dim{:d}-dropout{:.4f}-seqlen{:d}-{:s}-{:s}'.
