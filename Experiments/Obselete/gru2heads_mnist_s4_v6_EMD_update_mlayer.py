...
from Exp_Synthetic2.Minist_Apperance.CreateMNIST_2Heads_online_v6 import MNIST
...
def main():
    ...
    save_directory = 'gru2heads_mnist_s4-v6_EMD_mlayer_ckpt-assgin{:.2f}-alpha{:.4f}'.format(hassign_thres, args.alpha)
