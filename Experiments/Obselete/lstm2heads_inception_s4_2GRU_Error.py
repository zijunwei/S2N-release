#!/usr/bin/env python
#FIXME: This has multiple errors compared to the newest version
#1. Training data imbalanced
#2. Loss function averaged over all
#3. Not splitting!
import argparse
import os, sys
...
def main():
    ...
    save_directory = 'gru2heads_proposal_s4-3bal_ckpt'
