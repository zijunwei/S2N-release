# at training: ground truth is from ori, taking averate
# at evaluation: use ori
...
from Devs_vsSum.datasets import vsTVSum_Loader3_c3dd_oriavg
from Devs_vsSum.datasets import vsTVSum_Evaluator_MultiScale_ori as Evaluator
...
def main():
    ...
    train_dataset = vsTVSum_Loader3_c3dd_oriavg.cDataset(dataset_name=args.dataset, split='train', seq_length=args.seq_len, overlap=0.9, sample_rate=[args.sample_rate],
