# at training: ground truth is from ori
...
from Devs_vsSum.datasets import vsTVSum_Loader3_c3dd_orisep
...
def main():
    ...
    train_dataset = vsTVSum_Loader3_c3dd_orisep.cDataset(dataset_name=args.dataset, split='train', seq_length=args.seq_len, overlap=0.9, sample_rate=[args.sample_rate],
