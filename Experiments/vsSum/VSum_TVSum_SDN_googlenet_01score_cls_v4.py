...
from SDN.PointerGRU2Heads_v5 import PointerNetwork
from Devs_vsSum.datasets import vsTVSumLoader3_googlenet_01score
from Devs_vsSum.datasets import vsTVSum_Evaluator_MultiScale_googlenet_cls as Evaluator
...
def main():
    ...
    train_dataset = vsTVSumLoader3_googlenet_01score.cDataset(dataset_name=args.dataset, split='train', seq_length=args.seq_len, overlap=0.9, sample_rate=[args.sample_rate],
