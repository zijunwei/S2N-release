...
# from Exp_Synthetic_new.SDN_MNIST_s1_1_online import cDataset
from Devs_vsSum.datasets.vsSumLoader3_c3dd import cDataset
...
def main():
    ...
    train_dataset = cDataset(dataset_name=args.dataset, split='train', seq_length=args.seq_len, overlap=0.9, sample_rate=[4, 8])
    val_dataset =cDataset(dataset_name=args.dataset, split='val', seq_length=args.seq_len, overlap=0.9, sample_rate=[4, 8])
