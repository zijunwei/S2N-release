...
# compared to V3, this version uses regression and augmented more positives
import argparse
...
from Devs_ActionProp.datasets.THUMOS14.dataloader_c3dd_aug4_fast import cDataset
...
parser.add_argument('--alpha', default=1.0, type=float, help='trade off between classification and localization')
...
def main():
    ...
    train_dataset = cDataset(dataset_split='train', seq_length=args.seq_len, sample_rate=[4], rdOffset=False, rdDrop=True)#Update: set offset to false to not remvoe the ones on the bound
    ...
    for epoch in range(args.start_epoch, args.nof_epoch+args.start_epoch):
            ...
            for i_batch, sample_batch in enumerate(train_dataloader):
                ...
                if args.hmatch:
                    ...
                    assigned_scores, assigned_locations, assigned_overlaps, total_valid, total_iou = f_match.Assign_Batch_v2_repression(gt_positions, pred_positions, gt_valids, gt_overlaps, thres=args.hassign_thres)
