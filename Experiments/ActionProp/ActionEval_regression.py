...
from SDN.PointerGRU2Heads_v8_2 import PointerNetwork
...
parser.add_argument('--eval', type=str, default='/home/zwei/Dev/NetModules/ckpts/THUMOS/ActionExp_v4-N-assgin0.50-alpha1.0000-dim512-dropout0.5000-seqlen90-EMD-FIX', help='check-point file')
parser.add_argument('--fileid', type=int, default=19, help='file id in ckpt file')
...
def main():
    ...
    proposal_save_file = 'Dev/NetModules/Devs_ActionProp/PropEval/baselines_results/{:s}-{:04d}_thumos14_test.csv'.format(savefile_stem, ckpt_idx)
    ...
    model = PointerNetwork(input_dim=args.input_dim, embedding_dim=args.embedding_dim,
                           hidden_dim=args.hidden_dim, max_decoding_len=args.net_outputs, output_classes=1)
