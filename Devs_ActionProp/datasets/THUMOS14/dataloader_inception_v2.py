...
# on validation set, compared to v, also outputs vectors of 0s and 1s indicating actionness
...
class THUMOST14(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        actionness_labels = np.zeros(self.seq_len)
        ...
        for idx in range(n_effective_idxes):
            ...
            actionness_labels[p_start_position:p_end_position]=1
        ...
        actionness_labels = torch.FloatTensor(actionness_labels)
        return s_clip_feature, s_start_idxes, s_end_idxes, n_effective_idxes, actionness_labels
