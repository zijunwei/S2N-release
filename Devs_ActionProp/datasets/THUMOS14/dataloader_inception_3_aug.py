...
#Update: compared to -3, added data augmentation

# fix length, but at different sample rate, different dropping possibilities
# drop one or two frames
#compared to inception_t, also output vectors of 0s and 1s
...
class THUMOST14(data.Dataset):
    ...
    def __init__(self, seq_length=360, overlap=0.9, sample_rate=1, dataset_split='val', feature_file_ext='npy'):
        ...
        self.annotation_file = '/home/zwei/Dev/NetModules/ActionLocalizationDevs/PropEval/thumos14_{:s}_groundtruth.csv'.format(dataset_split)
    ...
    def __getitem__(self, index):
        ...
        actionness_scores = np.zeros(self.seq_len/self.sample_rate)
