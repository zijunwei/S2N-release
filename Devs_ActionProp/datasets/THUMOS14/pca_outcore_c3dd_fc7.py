...
# https://gist.github.com/escorciav/e4125c7a8a2e52ab4c47
...
def main(feat_dim=4096, log_loop=20):
    ...
    feature_files = glob.glob(os.path.join(feature_directory, 'video_validation_*'))
    ...
    pkl.dump({'x_mean': x_mean, 'U': U, 'S': S}, open('pca_c3dd_fc7_val_annot_thumos14.pkl', 'wb'))
