import argparse
import os
from opsio import process_proposal_list, parse_c3dfiles,z_process_proposal_list
...
dataset = 'thumos14'
frame_path = '/home/zwei/datasets/THUMOS14/features/c3d'
configs = get_configs(dataset)

norm_list_tmpl = '{}_normalized_proposal_list.txt'
out_list_tmpl = '{}_proposal_list_c3d.csv'
...
frame_dict = parse_c3dfiles(frame_path)
