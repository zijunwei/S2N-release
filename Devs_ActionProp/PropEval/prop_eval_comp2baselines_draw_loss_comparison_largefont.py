...
plt.savefig("./results/{:s}_avg_recall_comp.pdf".format(new_method), bbox_inches="tight")
# plt.show()
...
plt.setp(plt.axes().get_xticklabels(), fontsize=fn_size)
plt.setp(plt.axes().get_yticklabels(), fontsize=fn_size)
plt.savefig("./results/{:s}_freq_comp.pdf".format(new_method), bbox_inches="tight")
# plt.show()
...
plt.setp(plt.axes().get_xticklabels(), fontsize=fn_size)
plt.setp(plt.axes().get_yticklabels(), fontsize=fn_size)
plt.savefig("./results/{:s}_recall1000_comp.pdf".format(new_method), bbox_inches="tight")
# plt.show()
...
plt.setp(plt.axes().get_xticklabels(), fontsize=fn_size)
plt.setp(plt.axes().get_yticklabels(), fontsize=fn_size)
plt.savefig("./results/{:s}_recall_freq_comp.pdf".format(new_method), bbox_inches="tight")
# plt.show()
