...
baseline_name = 'ActionExp_v3_final-Release-assgin0.50-alpha0.1000-dim512-dropout0.50-seqlen90-EMD-HUG-0014-check-02'
overlap = 0.75
# save_name = 'ActionEXP_v3_NMS{:.2f}'.format(overlap)
save_name = 'release-check-02'
prediction_file = os.path.join(project_root, 'Devs_ActionProp/PropEval/baselines_results/{:s}_thumos14_test.csv'.format(baseline_name))
ground_truth_file = os.path.join(project_root,  'Devs_ActionProp/action_det_prep/thumos14_tag_test_proposal_list.csv')
