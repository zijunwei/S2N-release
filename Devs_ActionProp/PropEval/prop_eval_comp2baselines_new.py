...
method = {'DAPs': {'legend': 'DAPs-prop',
          ...
          'Random': {'legend': 'Random',
                     ...
                     'linewidth': 6.5,
                     'linestyle': '-'},
          'TURN-C3D-16': {'legend': 'TURN-C3D',
                          'color': np.array([224, 44, 119]) / 255.0,
                          'marker': None,
                          'linewidth': 6.5,
                          'linestyle': '-'},
          'TURN-FLOW-16': {'legend': 'TURN-FLOW',
...
avg_prop_pnt_pairs['TURN-C3D-16'] = np.load("./baseline_pnt_pairs/TURN-C3D-16_avg_prop_pnt_pairs.npy")
avg_prop_pnt_pairs['TURN-FLOW-16'] = np.load("./baseline_pnt_pairs/TURN-FLOW-16_avg_prop_pnt_pairs.npy")
...
freq_pnt_pairs['TURN-C3D-16'] = np.load("./baseline_pnt_pairs/TURN-C3D-16_freq_pnt_pairs.npy")
freq_pnt_pairs['TURN-FLOW-16'] = np.load("./baseline_pnt_pairs/TURN-FLOW-16_freq_pnt_pairs.npy")
...
recall1000_pnt_pairs['TURN-C3D-16'] = np.load("./baseline_pnt_pairs/TURN-C3D-16_recall_pnt_pairs.npy")
recall1000_pnt_pairs['TURN-FLOW-16'] = np.load("./baseline_pnt_pairs/TURN-FLOW-16_recall_pnt_pairs.npy")
...
recall_freq_pnt_pairs['TURN-C3D-16'] = np.load("./baseline_pnt_pairs/TURN-C3D-16_recall_freq_pnt_pairs.npy")
recall_freq_pnt_pairs['TURN-FLOW-16'] = np.load("./baseline_pnt_pairs/TURN-FLOW-16_recall_freq_pnt_pairs.npy")
legends = ['Random', 'Sliding Window', 'Sparse-prop', 'DAPs', 'TURN-C3D-16', 'TURN-FLOW-16', new_method]
...
plt.xlim([10 ** (-1), 10])
plt.yticks(np.arange(0.0, 0.9, 0.2))
plt.legend(legends, loc=4, prop={'size': legend_size})
plt.setp(plt.axes().get_xticklabels(), fontsize=fn_size)
plt.setp(plt.axes().get_yticklabels(), fontsize=fn_size)
