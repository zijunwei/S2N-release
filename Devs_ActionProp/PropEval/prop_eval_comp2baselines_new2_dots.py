...
# file_idx = 71
#TODO: update with lines of different colors and types
new_method = 'CLS-HUG'
...
plt.savefig("./results/{:s}_avg_recall.pdf".format(new_method), bbox_inches="tight")
# plt.show()
...
plt.setp(plt.axes().get_xticklabels(), fontsize=fn_size)
plt.setp(plt.axes().get_yticklabels(), fontsize=fn_size)
plt.savefig("./results/{:s}_freq.pdf".format(new_method), bbox_inches="tight")
# plt.show()
...
plt.setp(plt.axes().get_xticklabels(), fontsize=fn_size)
plt.setp(plt.axes().get_yticklabels(), fontsize=fn_size)
plt.savefig("./results/{:s}_recall1000.pdf".format(new_method), bbox_inches="tight")
# plt.show()
...
plt.setp(plt.axes().get_xticklabels(), fontsize=fn_size)
plt.setp(plt.axes().get_yticklabels(), fontsize=fn_size)
plt.savefig("./results/{:s}_recall_freq.pdf".format(new_method), bbox_inches="tight")
# plt.show()
