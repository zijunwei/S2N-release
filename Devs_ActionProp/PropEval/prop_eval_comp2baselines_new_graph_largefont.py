...
# file_idx = 71
new_method = 'EMD-HUG-release-check-02'
...
legends_toshow = ['Random', 'Sliding Window', 'Sparse-prop', 'DAPs', 'TURN-C3D', 'TURN-FLOW', 'S$^2$N (proposed)']
...
plt.legend(legends_toshow, loc=0, prop={'size': legend_size})
