...
avg_prop_pnt_pairs['TURN-C3D-16'] = np.load("./ref_pnt_pairs/TURN-C3D-16_avg_prop_pnt_pairs.npy")
avg_prop_pnt_pairs['TURN-FLOW-16'] = np.load("./ref_pnt_pairs/TURN-FLOW-16_avg_prop_pnt_pairs.npy")
avg_prop_pnt_pairs[new_method] = np.load("./ref_pnt_pairs/{:s}_avg_prop_pnt_pairs.npy".format(new_method))
...
freq_pnt_pairs['TURN-C3D-16'] = np.load("./ref_pnt_pairs/TURN-C3D-16_freq_pnt_pairs.npy")
freq_pnt_pairs['TURN-FLOW-16'] = np.load("./ref_pnt_pairs/TURN-FLOW-16_freq_pnt_pairs.npy")
freq_pnt_pairs[new_method] = np.load("./ref_pnt_pairs/{:s}_freq_pnt_pairs.npy".format(new_method))
...
recall1000_pnt_pairs['TURN-C3D-16'] = np.load("./ref_pnt_pairs/TURN-C3D-16_recall_pnt_pairs.npy")
recall1000_pnt_pairs['TURN-FLOW-16'] = np.load("./ref_pnt_pairs/TURN-FLOW-16_recall_pnt_pairs.npy")
recall1000_pnt_pairs[new_method] = np.load("./ref_pnt_pairs/{:s}_recall_pnt_pairs.npy".format(new_method))
...
recall_freq_pnt_pairs['TURN-C3D-16'] = np.load("./ref_pnt_pairs/TURN-C3D-16_recall_freq_pnt_pairs.npy")
recall_freq_pnt_pairs['TURN-FLOW-16'] = np.load("./ref_pnt_pairs/TURN-FLOW-16_recall_freq_pnt_pairs.npy")
recall_freq_pnt_pairs[new_method] = np.load("./ref_pnt_pairs/{:s}_recall_freq_pnt_pairs.npy".format(new_method))

legends = ['Random', 'Sliding Window', 'Sparse-prop', 'DAPs', 'SCNN-prop', 'TURN-C3D-16', 'TURN-FLOW-16', new_method]
...
plt.savefig("./results/{:s}_avg_recall.png".format(new_method), bbox_inches="tight")
# plt.show()
...
plt.setp(plt.axes().get_xticklabels(), fontsize=fn_size)
plt.setp(plt.axes().get_yticklabels(), fontsize=fn_size)
plt.savefig("./results/{:s}_freq.png".format(new_method), bbox_inches="tight")
# plt.show()
...
plt.setp(plt.axes().get_xticklabels(), fontsize=fn_size)
plt.setp(plt.axes().get_yticklabels(), fontsize=fn_size)
plt.savefig("./results/{:s}_recall1000.png".format(new_method), bbox_inches="tight")
# plt.show()
...
plt.setp(plt.axes().get_xticklabels(), fontsize=fn_size)
plt.setp(plt.axes().get_yticklabels(), fontsize=fn_size)
plt.savefig("./results/{:s}_recall_freq.png".format(new_method), bbox_inches="tight")
# plt.show()
