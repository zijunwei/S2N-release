...
import glob
import I3DUtils
from vsSummDevs.datasets.SumMe import path_vars
from vsSummDevs.datasets.SingleVideoFrameDataset import VideoChunkDataset
...
def main():
    ...
    save_root_directory = dir_utils.get_dir(os.path.join(path_vars.dataset_dir, 'features/Kinetics/I3D'))
    chunk_size = 64
    ...
    for idx_dir, s_image_direcotry in enumerate(image_directories):
        ...
        s_dataset = VideoChunkDataset(s_image_direcotry, chunk_size=chunk_size, transform=val_transform)
