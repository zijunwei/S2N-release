...
model_path = os.path.join(os.path.expanduser('~'), 'datasets/PretrainedModels/', 'Kinetics')
_CHECKPOINT_PATHS = {
    'rgb': os.path.join(model_path, 'rgb_scratch.pkl'),
    'flow': os.path.join(model_path, 'flow_scratch.pkl'),
    'rgb_imagenet': os.path.join(model_path, 'rgb_imagenet.pkl'),
    'flow_imagenet': os.path.join(model_path, 'flow_imagenet.pkl'),
}
