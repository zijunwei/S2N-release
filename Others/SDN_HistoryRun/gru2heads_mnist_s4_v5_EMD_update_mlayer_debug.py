...
from Exp_Synthetic2.Minist_Apperance.CreateMNIST_2Heads_online_v5 import MNIST
...
parser.add_argument('--resume', '-r', default='/home/zwei/Dev/NetModules/PtrNet2/gru2heads_mnist_s4-v5_EMD_mlayer_ckpt-0.75/checkpoint_{:04d}.pth.tar', type=str, help='resume from previous ')
...
def main():
    ...
    # save_directory = 'gru2heads_mnist_s4-v5_EMD_mlayer_ckpt-{:.2f}-alpha0.01'.format(hassign_thres)
