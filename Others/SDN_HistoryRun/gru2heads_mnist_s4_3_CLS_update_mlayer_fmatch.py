...
def main():
    ...
    save_directory = 'gru2heads_mnist_s4-3_CLS_mlayer_fmatch_ckpt'
    ...
    for epoch in range(args.start_epoch, args.nof_epoch+args.start_epoch):
            ...
            for i_batch, sample_batch in enumerate(train_dataloader):
                ...
                assigned_scores, assigned_locations = f_assign.Assign_Batch_all_valid(gt_positions, pred_positions, thres=0.5)
