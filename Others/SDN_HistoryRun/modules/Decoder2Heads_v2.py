...
class Decoder(nn.Module):
    def __init__(self,
        ...
        self.input_weights = nn.Linear(hidden_dim, 4 * hidden_dim)
    ...
    def forward(self, decoder_input, embedded_inputs, hidden, context, max_len=None):
        ...
        def recurrence(x, hidden, prev_e_enc):
            ...
            return hy, cy, logits_s, logits_e, idxs_s, idxs_e, cls_score, prev_e_enc
        ...
        for i in steps:
            hx, cx, probs_s, probs_e, idxs_head, idxs_tail, cls_score, prev_e_enc = \
