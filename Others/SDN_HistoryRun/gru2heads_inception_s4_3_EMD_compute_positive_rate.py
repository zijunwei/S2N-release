...
def main():
    ...
    save_directory = 'gru2heads_proposal_s4-3_EMD_ckpt'
    ...
    for epoch in range(args.start_epoch, args.nof_epoch+args.start_epoch):
            ...
            for i_batch, sample_batch in enumerate(train_dataloader):
                ...
                n_positive_segments += torch.sum(assigned_scores).item()
                n_negative_segments += len(assigned_scores)-torch.sum(assigned_scores).item()
            ...
            print("Positive_examples:{:d}\tNegative Examples:{:d}".format(n_positive_segments, n_negative_segments))
