...
from modules.Decoder2Heads_GRU_v4_mclass import Decoder

#Update: comapre to v5, we make the classifcation layer multi-class
#Update: GRU version
...
class PointerNetwork(nn.Module):
    ...
    def __init__(self,
            ...
            embedding_dim,
            hidden_dim,
            max_decoding_len,dropout=0.5, aux=False, n_enc_layers=2, output_class=4):  # TODO: added this elements in case we need states from previous sequences
        ...
        self.decoder = Decoder(
                embedding_dim,
                hidden_dim*2,
                max_length=max_decoding_len, output_class=output_class)
        self.aux = aux
        if self.aux:
