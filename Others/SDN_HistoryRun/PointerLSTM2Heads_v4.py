...
from modules.Encoder_bi import Encoder
from modules.Decoder2Heads_v2 import Decoder


#TODO compared to V3, this version will use bidirectional Encoder and a bunch of parameters representing starting states
...
class PointerNetwork(nn.Module):
    ...
    def __init__(self,
            ...
            embedding_dim,
            hidden_dim,
            max_decoding_len,dropout=0, aux=False):  # TODO: added this elements in case we need states from previous sequences
    ...
    def forward(self, inputs, decode_len=None):
        ...
        encoder_hx = self.enc_init_hx.unsqueeze(0).unsqueeze(0).repeat(2, batch_size, 1)
