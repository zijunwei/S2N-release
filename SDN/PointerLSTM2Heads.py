...
from modules.Decoder2Heads_LSTM import Decoder
...
class PointerNetwork(nn.Module):
    ...
    def __init__(self,
            ...
            embedding_dim,
            hidden_dim,
            max_decoding_len):  # TODO: added this elements in case we need states from previous sequences
    ...
    def forward(self, inputs, decode_len=None):
        ...
        return head_pointer_probs, head_positions, tail_pointer_probs, tail_positions, cls_scores
