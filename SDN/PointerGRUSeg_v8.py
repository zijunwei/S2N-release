...
from modules.DecoderSeg_GRU_v7 import Decoder
...
#Update: compared to v8, this is a sinlge pointer to the segments
class PointerNetwork(nn.Module):
    ...
    def forward(self, inputs, decode_len=None):
        ...
        pointer_probs, pointer_positions, cls_scores, dec_hidden_t = self.decoder(decoder_input,
                embedded_inputs,
                dec_init_state,
        ...
        pointer_positions = torch.stack(pointer_positions)
        pointer_positions = pointer_positions.permute(1, 0)




        return pointer_probs, pointer_positions, cls_scores, enc_action_scores
