...
from modules.Decoder2Heads_GRU_v5 import Decoder
...
#Update: compared to v5, the input to the decoding stage are based on the previous encoder hidden state while in v5, the input state is learned for all outputs
