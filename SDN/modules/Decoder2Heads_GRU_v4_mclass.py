...
#Update: compared to v4, this considers multiple class
class Decoder(nn.Module):
    def __init__(self,
                 embedding_dim,
                 hidden_dim,
                 max_length, output_class=4):
        ...
        self.cls = torch.nn.Conv1d(hidden_dim, output_class, kernel_size=3, stride=1, padding=0)
