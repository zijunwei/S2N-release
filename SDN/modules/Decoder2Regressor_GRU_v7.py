...
#Update: compared to v7, this is currently a regressor!
class Decoder(nn.Module):
    def __init__(self,
        ...
        self.regressor_s = nn.Linear(hidden_dim, 1)
        self.regressor_e = nn.Linear(hidden_dim, 1)
    ...
    def forward(self, decoder_input, embedded_inputs, hidden, context, max_len=None):
        ...
        def recurrence(x, hidden):
            ...
            return hy, next_input, logits_s, logits_e, _, _, cls_score
