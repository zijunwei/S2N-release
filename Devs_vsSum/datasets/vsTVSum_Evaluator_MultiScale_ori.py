# evaluate based on ori annotations
...
class Evaluator():
    ...
    def __init__(self, dataset_name='TVSum', split='train', seq_length=90, overlap=0.9, sample_rate=None,
        ...
        for s_video_idx, s_filename in enumerate(self.filenames):
            ...
            s_combine_segments, s_combine_segment_scores = LoaderUtils.convertscores2segs(raw_combine_summaris)
            ...
            self.groundtruthscores.append(raw_user_summaris_01)
