...
for video_idx, s_filename in enumerate(videofile_stems):
    ...
    video_features, _, feature_sizes = SumMeMultiViewFeatureLoader.load_by_name(s_filename, doSoftmax=doSoftMax)
    feature_boundary = [0]
    ...
    s_F1_score, _, _ = vsum_tools.evaluate_summary(machine_summary, user_summary, 'max')
