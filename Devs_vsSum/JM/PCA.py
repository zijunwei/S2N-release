...
dataset_path = '/home/zwei/datasets/KY_AAAI18/datasets/eccv16_dataset_tvsum_google_pool5.h5'
...
for video_idx, s_key in enumerate(dataset_keys):
    ...
    machine_summary = sum_tools.generate_summary(probs, cps, n_frames, nfps, positions)
    s_F1_score, _, _ = sum_tools.evaluate_summary(machine_summary, user_summary, eval_method)
