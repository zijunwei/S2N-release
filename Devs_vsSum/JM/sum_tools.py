...
def generate_summary_ky(ypred, cps, n_frames, nfps, positions, proportion=0.15):
...
def evaluate_summary(machine_summary, user_summary, eval_metric='avg', return_user_id=False):
    ...
    for user_idx in xrange(n_users):
        ...
        overlap_duration = (machine_summary * gt_summary).sum()*1.
    ...
    if return_user_id:
        return final_f_score, final_prec, final_rec, max_idx
    else:
